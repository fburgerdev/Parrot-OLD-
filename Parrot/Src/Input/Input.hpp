...
namespace Parrot
{
	namespace Input
	{
		...
		public:
			...
			enum class MouseIcon : uint32_t
			{
				Hidden, Normal, IBeam
			};

			// Returns the state for the specified mouse button
			// Inputs: "Left", "Middle", "Right"
			// Outputs: "Released", "Pressed"
		...
		public:
			...
			// Returns the state for the specified key.
			// Inputs: KEY_<KEY_NAME>
			// Outputs: "Released", "Pressed", "Repeated"
